...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ color: color.white }}>
          {" "}
          <span style={{ color: color.orange }}>Get</span> A Competitive Instant
          Quote
        </h2>
        <p style={{ color: "white" }}>
                ...
                {[
                  {
                    ...
                    type: "select",
                    name: "pickLocation",
                    icon: "../../../public/location2.svg",
                  },
                  {
                    label: "Pick Date",
                    type: "date",
                    name: "pickDate",
                    icon: "../../../public/date.svg",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    type: "select",
                    name: "weight",
                    icon: "../../../public/weight.svg",
                  },
                  {
                    label: "Load",
                    type: "text",
                    name: "load",
                    icon: "../../../public/load.svg",
                  },
                  {
                    label: "Text",
                    type: "text",
                    name: "text",
                    icon: "../../../public/name.svg",
                  },
                  {
                    label: "Email",
                    type: "email",
                    ...
                    <div className="inputContainer">
                      ...
                      {field.type === "select" ? (
                        <select
                          ...
                          id={field.name}
                        >
                          <option value={field.name} disabled selected hidden>
                            {field.label}{" "}
                          </option>
                        </select>
                      ) : (
