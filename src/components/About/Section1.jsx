    ...
    >
      ...
      <Box sx={{ width: "100%", display: "flex", justifyContent: "center" }}>
        ...
        >
          <Grid
            ...
            className={isVisible ? "Section1Card" : ""}
          >
            <Card
          ...
          <Grid
            ...
            md={4}
            sx={{ display: "flex" }}
            className={isVisible ? "Section1Card2" : ""}
          >
            <Card
              handleSelectNavbarElement={handleSelectNavbarElement}
              selected={selected}
          ...
          <Grid
            ...
            md={4}
            sx={{ display: "flex" }}
            className={isVisible ? "Section1Card3" : ""}
          >
            <Card
              handleSelectNavbarElement={handleSelectNavbarElement}
              selected={selected}
      ...
      >
        <Grid
          ...
          sm={12}
          md={5}
          sx={{ maxWidth: "100%", paddingLeft: "0 !important" }}
